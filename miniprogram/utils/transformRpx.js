/**
 * 将rpx转化为px，返回转化后的px整数，参数是Number
 * 例如transformRpx("140rpx")，返回70
 * https://raw.githubusercontent.com/wechat-miniprogram/recycle-view/master/src/utils/transformRpx.js
 */
let isIPhone = false
let deviceWidth
let deviceDPR
